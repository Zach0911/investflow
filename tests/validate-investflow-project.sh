...
need_file "packs/community/long-term-investing/pack.json"
need_dir "skills"
need_dir "docs"
need_dir "examples"
need_dir "templates"
...
need_text "README.md" "Project Status"
need_text "README.md" "CHANGELOG.md"
...
need_text "README.md" "MCP and Data Connectors"
...
need_text "README.zh-CN.md" "项目状态"
need_text "README.zh-CN.md" "CHANGELOG.md"
...
need_text "README.zh-CN.md" "MCP 和只读数据连接器"
...
need_text "docs/phase-4-report-community-requirements.zh-CN.md" "pack validate"
need_text ".codex-plugin/plugin.json" "\"mcpServers\": \"./.mcp.json\""
need_text ".mcp.json" "\"investflow\""
...
need_text ".codex-plugin/plugin.json" "\"version\": \"0.2.0\""
...
need_text ".github/workflows/validate.yml" "0.2.0"
need_text "CHANGELOG.md" "0.2.0"
need_text "CHANGELOG.md" "Superpowers-inspired"
